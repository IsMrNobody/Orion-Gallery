...
export default {
  ...
  data: () => ({
    carteles: [
      ...
      {
        src:
          'https://firebasestorage.googleapis.com/v0/b/orion-gallery-116f8.appspot.com/o/Galeria%2Fcinturon%2Falnitak.png?alt=media&token=80c07545-d6db-4094-b0f6-5d90bce690fa'
      }
    ]
  })
}
